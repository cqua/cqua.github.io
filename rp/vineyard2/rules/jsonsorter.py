...
for p in data:
	if p["rank"] < 6 and p["tradition"] not in ["curse", "death", "demonology", "metal", "invocation", "forbidden", "fey", "order", "spiritualism", "madness", "necromancy", "soul"]:
		spelldesc()
		i += 1